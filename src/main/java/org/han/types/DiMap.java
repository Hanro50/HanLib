...
/**
 * Bidirectional Map. For use with one-to-one relationships Warning: DO NOT USE
 * THIS IN A MULTITHREADED APP. IT'S NOT DESIGNED FOR THAT AND MIGHT BREAK IN
 * WEIRD WAYS
 * 
 * </br>
 * </br>
...
public class DiMap<k1, k2> {
	@Expose
	protected Map<k1, k2> k1tok2;
	@Expose
	protected Map<k2, k1> k2tok1;

	public DiMap<k1, k2> copySelf() {
		DiMap<k1, k2> copyself = new DiMap<k1, k2>();
		copyself.k1tok2.putAll(k1tok2);
		copyself.k2tok1.putAll(k2tok1);
		return copyself;
	}
