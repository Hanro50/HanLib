...
/**
 * Bidirectional MultiMap. For use with many-to-many relationships Warning: DO
 * NOT USE THIS IN A MULTITHREADED APP. IT'S NOT DESIGNED FOR THAT AND MIGHT
 * BREAK IN WEIRD WAYS
 * 
  * </br>
 * </br>
...
public class DiMultiMap<k1, k2> {
	...
	public synchronized void add(k1 key1, k2 key2) {
	...
	public synchronized void remove(k1 key1, k2 key2) {
		k1tok2.get(key1).remove(key2);
		k2tok1.get(key2).remove(key1);
	}

	public synchronized void removeKey1(k1 value) {
		if (k1tok2.containsKey(value)) {
	...
	public synchronized void removeKey2(k2 value) {
		if (k2tok1.containsKey(value)) {
