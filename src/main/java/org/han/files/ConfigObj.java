...
public class ConfigObj extends FileHandlingBase {
	...
	public ConfigObj(String ClassPath, String Path, String FileName, String FileExtention, FIleUtil FU) {
	 ...
	 */
	public ConfigObj(String Path, String FileName, String FileExtention, FIleUtil FU) {
